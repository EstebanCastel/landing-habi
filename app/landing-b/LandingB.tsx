  ...
  return (
    <div key={`${dealUuid}-${_forceUpdate}`} className="min-h-screen bg-gray-50">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 flex items-center gap-2 px-5 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 z-50 no-print"
        style={{ backgroundColor: "#8A00E6", color: "white" }}
