    ...
    <div ref={sectionRef} id="property-info-section" className="p-6 bg-gradient-to-br from-purple-50 via-white to-white">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-white p-3 rounded-lg border border-gray-100 text-center">
          ...
          <p className="text-lg font-bold text-gray-900">{propertyData.tipoInmueble}</p>
        ...
        <div className="bg-white p-3 rounded-lg border border-gray-100 text-center">
          ...
          <p className="text-lg font-bold text-gray-900">{propertyData.habitaciones}</p>
        ...
        <div className="bg-white p-3 rounded-lg border border-gray-100 text-center">
          ...
          <p className="text-lg font-bold text-gray-900">{propertyData.banos}</p>
