...
export default function PersonalAdvisor({ whatsappAsesor, country }: PersonalAdvisorProps) {
  ...
  return (
    <div className="px-6 py-6 border-t border-gray-100">
      <p className="text-xs text-gray-500 uppercase tracking-wide mb-4">Tu asesor personal</p>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="w-12 h-12 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center flex-shrink-0 transition-colors"
        >
